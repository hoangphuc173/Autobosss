...
public class Plugin : BasePlugin
{
    ...
    public override void Load()
    {
        ...
        try
        {
            ...
            // ((BasePlugin)this).AddComponent<T>() attach vào gameObject c?a BepInEx plugin —
            // gameObject dó n?m trong DontDestroyOnLoad và Update() du?c Unity loop g?i bình thu?ng.
